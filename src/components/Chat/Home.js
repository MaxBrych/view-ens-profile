...
export default function Home({ receiverAddress }) {
  const PEER_ADDRESS =
    receiverAddress || "0xed5D5FdC6cee4e5dBAca127aE0eC29C335481877"; // Fallback to hardcoded address if prop is not passed
